...
# Estilização CSS Customizada (Visual Premium e Fluido)
st.markdown("""
    <style>
        ...
        * {
        ...
        /* Estilo geral do fundo e botões */
        .main {
        ...
        .stButton>button {
            background: linear-gradient(135deg, #1d70b8 0%, #005a9c 100%) !important;
            ...
            box-shadow: 0 4px 15px rgba(29, 112, 184, 0.2) !important;
        }
        
        .stButton>button:hover {
            transform: translateY(-2px) !important;
            box-shadow: 0 6px 20px rgba(29, 112, 184, 0.3) !important;
        }
...
st.markdown("""
    <div class="header-container">
        <div class="header-title">Water Lab 💧</div>
        <div class="header-subtitle">Plataforma de Coleta e Registro de Dinâmicas</div>
    </div>
""", unsafe_allow_html=True)

# Indicador de conexão na barra lateral
client_status = get_gspread_client()
if client_status:
    st.sidebar.success("🟢 Conectado ao Google Sheets!")
else:
    st.sidebar.warning("⚠️ Rodando em Modo Demonstração (Sem conexão com Sheets)")
